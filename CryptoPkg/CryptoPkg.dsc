...
[Defines]
  ...
  OUTPUT_DIRECTORY               = Build/CryptoPkg # MU_CHANGE Move to OneCrypto
...
#!if $(CRYPTO_SERVICES) == TARGET_UNIT_TESTS # MU_CHANGE - Start - Move to OneCrypto
#!include UnitTestFrameworkPkg/UnitTestFrameworkPkgTarget.dsc.inc
#!endif # MU_CHANGE - Start - Move to OneCrypto
...
#  OpensslLib|CryptoPkg/Library/OpensslLib/OpensslLib.inf # MU_CHANGE - Move to OneCrypto
  IntrinsicLib|CryptoPkg/Library/IntrinsicLib/IntrinsicLib.inf
  HmacSha1Lib|CryptoPkg/Library/HmacSha1Lib/HmacSha1LibNull.inf # MU_CHANGE - Move to OneCrypto
  BaseCryptLib|CryptoPkg/Library/BaseCryptLibNull/BaseCryptLibNull.inf # MU_CHANGE - Move to OneCrypto
...
#  gEfiCryptoPkgTokenSpaceGuid.PcdCryptoServiceFamilyEnable.Camellia.Family                          | PCD_CRYPTO_SERVICE_ENABLE_FAMILY
#!endif
#
